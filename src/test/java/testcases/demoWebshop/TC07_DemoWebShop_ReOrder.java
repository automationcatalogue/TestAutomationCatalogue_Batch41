...
public class TC07_DemoWebShop_ReOrder extends TestRunner {
    ...
    public void tearDown(ITestResult result) throws Exception {
        ...
        if (result.getStatus() == ITestResult.SUCCESS) {
            ...
            logger.log(Status.PASS, "DemoWebShop ReOrder TestCase is Passed and status is updated in Excel sheet");
            ...
            if (!BaseClass.failureReason.equalsIgnoreCase("TestId is not found")) {
                ...
                logger.log(Status.FAIL, "DemoWebShop ReOrder TestCase is Failed and status is updated in Excel sheet");
            }
