...
public class TC03_OrangeHRM_AddUser extends TestRunner {
    ...
    public void prerequisites(@Optional(Config.AddUserTestCase_ID) String testID) throws Exception {
        ...
        logger = extent.createTest("OrangeHRMAddzuser_"+testID);
    ...
    //Reading the TestData from Excel file
        userName_1 = ExcelUtils.getCellData(sheetName, rowNum, Config.col_UserName);
     log.info("UserName from excel sheet is :"+userName_1);
        ...
        confirm_pwd = ExcelUtils.getCellData(sheetName, rowNum, Config.col_AddUser_ConfirmPassword);
        log.info("confirm_pwd from excel sheet is :"+confirm_pwd;
    }
